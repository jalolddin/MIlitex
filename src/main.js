...
const i18n = createI18n({
  ...
  messages: {
    ru: {
        ...
        address: 'Узбекистан, г.Ташкент, Чиланзарский район, 10 квартал 4А',
        tashkent: 'Ташкент',
        guliston: 'Гулистон',
    ...
    en: {
      ...
      yarn30: 'Carded yarn Ne 32/1, 100%',
      yarnNe: 'Rotor-spinning carded yarn <br> Ne 32/1, 100%',
      address: 'Uzbekistan, Tashkent, Chilanzar district, 10 quarter 4A',
      tashkent: 'Tashkent',
      guliston: 'Guliston',
