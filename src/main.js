...
const i18n = createI18n({
  ...
  messages: {
    ru: {
        ...
        ecologicalDesc: 'Экологичность производства и <br> соответствие международным <br> стандартам',
    ...
    en: {
      ...
      contacts: 'Contacts',
      headerTitle: 'High quality <br> textile products in <br> Mili Tex Group ',
      ...
      ecologicalDesc: 'Environmentally friendly production and <br> compliance with international <br>   standards',
